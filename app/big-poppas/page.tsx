...
import {
  ...
  TapedPhoto,
  vars,
} from '@/components/bp-graffiti';

export const metadata: Metadata = {
  title: "Big Poppa's Kettle Corn — Fresh Batch, Big Flavor | Soady Poppers, Fairview MI",
  description:
    "Big Poppa's Kettle Corn — Soady Poppers' popcorn sub-brand. Fresh-batch, hand-bagged kettle corn with an attitude: Original Kettle, Caramel Apple, Choco Cherry, Big Apple and the premium Elite Eats collection. Popped fresh in Fairview, Michigan.",
};
...
const NEON: Record<string, { fill: string; shadow: string; glow: string }> = {
  ...
  purple: { fill: 'var(--bp-purple)', shadow: 'var(--bp-lime)', glow: 'rgba(162,92,255,0.6)' },
  yellow: { fill: 'var(--bp-yellow)', shadow: 'var(--bp-pink)', glow: 'rgba(242,229,32,0.55)' },
};

// Fixed rotations so the sticker wall looks hand-slapped but stays stable
// between server + client renders (no hydration mismatch).
const STICKER_ROT = [-5, 4, -3, 6, -6, 3, -4, 5, -2];
  ...
  return (
    <div className="bp-scope">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-10 items-center py-20 md:py-28">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start items-center">
                <div className="relative">
                  <a href="#flavors" className="bp-btn">See the Flavors</a>
      ...
      <section id="flavors" className="relative overflow-hidden bp-concrete scroll-mt-20">
        ...
        <Splat className="absolute top-[62%] -left-8 w-32 opacity-35 -rotate-[20deg]" color="var(--bp-purple)" />
        <Splat className="absolute bottom-[6%] right-[14%] w-24 opacity-35 rotate-[160deg]" color="var(--bp-yellow)" />
        <Splat className="absolute top-[8%] left-[38%] w-20 opacity-25 rotate-[80deg]" color="var(--bp-cyan)" />
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 md:pt-32 md:pb-24 relative">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3.5 md:gap-5 max-w-4xl mx-auto">
            {bigPoppa.flavors.map((f, i) => (
              <span
                key={f.name}
                className="bp-sticker"
                style={{ backgroundColor: NEON[f.color].fill, transform: `rotate(${STICKER_ROT[i % STICKER_ROT.length]}deg)` }}
              >
                {f.name}
              </span>
            ))}
            <span
              className="bp-sticker"
              style={{ backgroundColor: 'var(--bp-gold)', transform: `rotate(${STICKER_ROT[bigPoppa.flavors.length % STICKER_ROT.length]}deg)` }}
            >
              Elite Eats
            </span>
          </div>
      ...
      <section className="relative overflow-hidden bp-brick">
        ...
        <Splat className="absolute top-[26%] -left-8 w-36 opacity-30 rotate-[70deg]" color="var(--bp-pink)" />
        <Splat className="absolute bottom-[8%] right-[3%] w-28 opacity-30 -rotate-[15deg]" color="var(--bp-yellow)" />
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 md:pt-32 md:pb-24 relative">
          <div className="text-center mb-14 flex flex-col items-center">
            ...
            <h2 className="bp-throw text-4xl md:text-6xl mt-4" style={vars({ '--bp-fill': 'var(--bp-cyan)', '--bp-shadow': 'var(--bp-pink)' })}>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-12 gap-5 items-start">
            <TapedPhoto rotate={-2} className="col-span-2 lg:col-span-6">
              <GalleryFrame src="/popcorn2.webp" alt="Big Poppa's flavor lineup on the shop shelf" ratio="lg:aspect-[16/10] aspect-[4/3]" />
            </TapedPhoto>
            <TapedPhoto rotate={2} className="lg:col-span-6">
              <GalleryFrame src="/popcorn1.webp" alt="Hand-bagged kettle corn stacked on the brick shelf" ratio="aspect-[4/3]" />
            </TapedPhoto>
            <TapedPhoto rotate={-3} className="lg:col-span-3 mt-2">
              <GalleryFrame src="/popcorn3.webp" alt="Close-up of green caramel-apple kettle corn" ratio="aspect-square" />
            </TapedPhoto>
            <TapedPhoto rotate={3} className="lg:col-span-3 mt-2">
              <GalleryFrame src="/popcorn4.webp" alt="Close-up of electric-blue candied kettle corn" ratio="aspect-square" />
            </TapedPhoto>
            <TapedPhoto rotate={2} className="lg:col-span-3 mt-2">
              <GalleryFrame src="/popcorn5.webp" alt="Close-up of deep-red cherry kettle corn" ratio="aspect-square" />
            </TapedPhoto>
            <TapedPhoto rotate={-2} className="lg:col-span-3 mt-2">
              <GalleryFrame src="/popcorn6.webp" alt="Close-up of red, white and blue Bomb Pop kettle corn" ratio="aspect-square" />
            </TapedPhoto>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden" style={{ backgroundColor: '#0c0a06' }}>
        ...
        />
        <Splat className="absolute top-[20%] left-[4%] w-28 opacity-25 rotate-[120deg]" color="var(--bp-gold)" />
        <Splat className="absolute bottom-[12%] right-[6%] w-24 opacity-20 -rotate-[40deg]" color="var(--bp-yellow)" />
        <div className="container mx-auto px-4 pt-28 pb-20 md:pt-32 md:pb-24 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2
                ...
                style={vars({ '--bp-fill': 'var(--bp-gold)', '--bp-shadow': '#1c1405' })}
              >
                {bigPoppa.elite.name}
              </h2>
      ...
      <section className="relative overflow-hidden bp-concrete">
        ...
        <Splat className="absolute top-[30%] right-[14%] w-20 opacity-40 rotate-[200deg]" color="var(--bp-yellow)" />

        <div className="container mx-auto px-4 pt-28 pb-20 md:pt-32 md:pb-24 text-center relative">
          <span className="bp-swipe bp-graffiti text-lg tracking-[0.12em]" style={vars({ color: '#0a0a0c', '--bp-swipe-color': 'var(--bp-lime)' })}>
            Now Popping
          </span>
          <h2 className="bp-throw text-5xl md:text-7xl mt-4" style={vars({ '--bp-fill': 'var(--bp-bone)', '--bp-shadow': 'var(--bp-cyan)' })}>
          ...
          <div className="mt-9 flex flex-col sm:flex-row gap-3 justify-center items-center">
            ...
            <a href={bigPoppa.facebook} target="_blank" rel="noopener noreferrer" className="bp-btn bp-btn-ghost">
              Follow Us on Facebook
            </a>
          </div>
          <p className="mt-10 bp-tag text-2xl bp-neon-pink">Fresh Batch. Big Flavor.</p>
        </div>
      </section>
    </div>
  );
